...
pub fn rules() -> Vec<Rule> {
    vec![
        ...
        Rule {
            ...
            inspection: "Does a variable that another party controls reach the text of a query, command, code, markup, file path, requested URL or redirect target without being bound, escaped or checked?",
        ...
        Rule {
            ...
            scope: "application functions, each file's top-level statements that call something, and the settings objects of `next.config` files",
